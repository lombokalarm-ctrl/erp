          ...
          {canWrite ? (
            <Button
              ...
              onClick={() => {
                ...
                setFullName("");
                setPassword("");
                if (roles[0]?.id) setRoleId(roles[0].id);
                setIsFormOpen(true);
              }}
            >
              Tambah User
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
          <Card className="w-full max-w-2xl p-5 shadow-2xl">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-base font-semibold">Tambah User</div>
                <p className="text-xs text-zinc-500">Buat akun baru dan tentukan role aksesnya.</p>
              </div>
              <button
            ...
            <div className="mt-3 grid gap-3">
              ...
              <div className="flex items-center justify-end gap-2 pt-2">
                ...
                <Button disabled={!canCreate} onClick={handleCreateUser}>
                  Simpan User
                </Button>
              </div>
            </div>
