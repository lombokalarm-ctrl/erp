...
const permissions = [
  ...
  { code: 'inventory:approve_level1', description: 'Persetujuan transfer gudang level 1' },
  { code: 'inventory:approve_level2', description: 'Persetujuan transfer gudang level 2' },
